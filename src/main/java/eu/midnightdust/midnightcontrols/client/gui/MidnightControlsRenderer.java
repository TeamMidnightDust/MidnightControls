...
public class MidnightControlsRenderer {
    ...
    public static int drawButton(DrawContext context, int x, int y, int button, @NotNull MinecraftClient client) {
        ...
        var texture =  axis ? MidnightControlsClient.CONTROLLER_AXIS : button >= 15 && button <= 19 ? MidnightControlsClient.CONTROLLER_EXPANDED :MidnightControlsClient.CONTROLLER_BUTTONS;
        ...
        context.drawTexture(texture, x + (ICON_SIZE / 2 - assetSize / 2), y + (ICON_SIZE / 2 - assetSize / 2),
